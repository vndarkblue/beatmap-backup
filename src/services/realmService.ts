...
// Define interface for BeatmapSet (used for typing when fields match)
interface BeatmapSet {
  ID: Realm.BSON.UUID
  OnlineID?: number | null
}

// Note: We will open Realm in dynamic mode (no schema provided) to tolerate
// upstream schema changes from osu!lazer without forcing a strict schema here.
